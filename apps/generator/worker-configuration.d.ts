/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5686cb7e5d6a33bd8a5168de4e6d2031)
// Runtime types generated with workerd@1.20250730.0 2025-03-15 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    OPENROUTER_API_KEY: string;
    ASSISTANT_WRAPPER: DurableObjectNamespace<
      import("./src/index").AssistantMessageWrapper
    >;
    CHANNEL_SERVICES: Service<import("../channel-services/src/index").default>;
