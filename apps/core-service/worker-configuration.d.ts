/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d990ea187452d104a03b9c9115992889)
// Runtime types generated with workerd@1.20250612.0 2025-06-20 nodejs_compat_populate_process_env,nodejs_compat_v2
declare namespace Cloudflare {
	interface Env {
		DATABASE_URL: string;
		HYPERDRIVE: Hyperdrive;
		INTEGRATIONS_GATEWAY: Service<import('../integrations-gateway/src/index.ts').default>;
		APIS_GATEWAY: Service<import('../apis-gateway/src/index.ts').default>;
		CHANNEL_SERVICES: Service<import('../channel-services/src/index.ts').default>;
		LOGS: D1Database;
		JWK_PRIVATE_KEY: string;
		JWK_PUBLIC_KEY: string;
		AUTHENTICATED_ROLE: string;
		DATABASE_CACHE: KVNamespace;
