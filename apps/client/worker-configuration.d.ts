/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0bebd15bb596100d049db7fafa21f84c)
// Runtime types generated with workerd@1.20250730.0 2025-06-13 nodejs_compat_v2
declare namespace Cloudflare {
  interface Env {
    VITE_FACEBOOK_APP_ID: string;
    VITE_FACEBOOK_CONFIG_ID: string;
    VITE_PARTNER_SOLUTION_ID: string;
    RAG: R2Bucket;
    CORE_SERVICE: {
      mainDatabaseHandler: (body: any) => Promise<any>;
      storageCacheHandler: (body: any) => Promise<any>;
