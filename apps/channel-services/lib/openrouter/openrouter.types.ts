...
export type Message =
	...
	| {
			role: 'assistant';
			content: string | null;
			tool_calls?: { id: string; type: string; function: { name: string; arguments: string } }[]; // Optional and can be an empty array
	  };
...
export type OpenRouterRequest = {
	...
	response_format?: { type: 'json_schema'; json_schema: {} } | { type: 'json_object' } | undefined;
